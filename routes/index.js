...
var myAPIKEY = "71cbaf54b36fe92c4b57de36fda25557" 

/* GET home page. */

router.get('/new-movies', function(req, res, next) {
  var data = request("GET", `https://api.themoviedb.org/3/discover/movie?api_key=${myAPIKEY}&language=fr-FR&region=FR&sort_by=release_date.desc&include_adult=false&include_video=false&page=1&release_date.lte=2020-10-01`);
